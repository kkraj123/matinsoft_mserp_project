...
import 'package:mserp/screens/onboarding/size_config.dart';
import 'package:mserp/themes/theme_provider.dart';
import 'package:provider/provider.dart';

import '../../themes/app_cololors.dart';
                  ...
                  _currentPage + 1 == contents.length
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: isDark ? AppColors.darkPrimaryLightColor : Theme.of(context).primaryColor,
                      ...
                      child: Text("START", style: TextStyle(color: isDark ? AppColors.colorWhite : Colors.white),),
                    ),
                  )
                      : Padding(
                    padding: const EdgeInsets.all(30),
                    child: Row(
                      ...
                      children: [
                        TextButton(
                          ...
                          child: Text(
                            "SKIP",
                            style: TextStyle(color: isDark ? AppColors.colorWhite : Colors.black),
                          ),
                        ),
                        ElevatedButton(
                          onPressed: () {
